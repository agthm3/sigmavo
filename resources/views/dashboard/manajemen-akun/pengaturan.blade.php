...
@section('content')
<main class="flex-1 overflow-y-auto bg-gray-50 p-4 lg:p-8 custom-scrollbar" x-data="{ openAddProdiModal: false, openEditProdiModal: false, activeProdi: null }">
    
    <!-- HEADER HALAMAN -->
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight">Pengaturan Global Portal</h1>
            <p class="text-sm text-gray-500 mt-1">Kelola data master Program Studi, parameter sistem magang, dan konfigurasi umum SIGMAVO.</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <!-- KOLOM KIRI: LIST MASTER PROGRAM STUDI (8 Cols) -->
                    ...
                    <table class="w-full text-left border-collapse text-sm">
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-100 text-gray-500 uppercase text-[11px] font-bold tracking-wider">
                                ...
                                <th class="p-4">Mahasiswa / Dosen</th>
                        ...
                        <tbody class="divide-y divide-gray-100 text-gray-700">
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="p-4 text-xs text-gray-500">
                                    <i class="fas fa-user-graduate mr-1 text-gray-400"></i> {{ $prodi->mahasiswas_count }} Mhs • 
                                    <i class="fas fa-chalkboard-teacher mr-1 text-gray-400"></i> {{ $prodi->dosens_count }} Dosen
                                </td>
...
<div class="lg:col-span-4 space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-200/80 shadow-sm space-y-4">
                ...
                <!-- Form Tersimpan Nyata ke Database -->
                <form action="{{ route('dashboard-manajemen-pengaturan-settings-update') }}" method="POST" class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-gray-400 mt-1">Maksimal posisi yang dapat dilamar bersamaan per mahasiswa.</p>
                    </div>
            ...
            <!-- Bagian Sekretariat yang Juga BISA Diubah -->
